...
- Los archivos `docs/adr/001-stack-tecnologico.md`, `docs/adr/002-seguridad-abierta-mvp.md`, `docs/adr/003-almacenamiento-manuales-disco-local.md`, `docs/adr/004-embeddings-y-procesamiento-async.md`, `docs/adr/005-busqueda-asistida-manuales.md` y `docs/adr/006-chat-rag-por-vehiculo.md` están presentes y verificados.
- **Tests reales**: 164 tests (145 unitarios + 19 de integración), todos verdes en `mvn verify` (Java 21). Detalle por suite en `docs/METRICS.md`. Cifra verificada ejecutando la suite, no por grep.
