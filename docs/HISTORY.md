...
- **Tests**: 211 → **231** (195 unitarios + 36 de integración): +14 `AlmacenamientoS3Test`, +3 `AlmacenamientoContratoTest`, +2 `SeleccionDeAlmacenamientoIT`, +1 de descarga ajena en `MultiTenenciaIT`.
